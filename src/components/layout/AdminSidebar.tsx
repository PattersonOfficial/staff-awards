    ...
    <aside className='flex w-64 flex-col border-r border-border-light dark:border-border-dark bg-card-light dark:bg-card-dark p-4'>
      ...
      <nav className='mt-6 flex flex-1 flex-col gap-1'>
        <Link href='/admin' className={getLinkClass('/admin')}>
          ...
          <span
            className={`text-sm ${
              isActive('/admin') ? 'font-semibold' : 'font-medium'
            }`}>
            Dashboard
          </span>
        </Link>
        <Link
          ...
          <span
            className={`text-sm ${
              isActive('/admin/categories') ? 'font-semibold' : 'font-medium'
            }`}>
            Categories
          </span>
        </Link>
        <Link href='/admin/staff' className={getLinkClass('/admin/staff')}>
          ...
          <span
            className={`text-sm ${
              isActive('/admin/staff') ? 'font-semibold' : 'font-medium'
            }`}>
            Staff
          </span>
        </Link>
        <Link
          ...
          <span
            className={`text-sm ${
              isActive('/admin/nominations') ? 'font-semibold' : 'font-medium'
            }`}>
            Nominations
          </span>
        </Link>
        <Link href='/admin/voting' className={getLinkClass('/admin/voting')}>
          ...
          <span
            className={`text-sm ${
              isActive('/admin/voting') ? 'font-semibold' : 'font-medium'
            }`}>
            Results
          </span>
        </Link>
        <Link
          ...
          <span
            className={`text-sm ${
              isActive('/admin/settings') ? 'font-semibold' : 'font-medium'
            }`}>
            Settings
          </span>
        </Link>
